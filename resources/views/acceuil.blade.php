    ...
    <body>
        <div class="hero" id="Acceuil">
            <nav class="navbar">
                ...
                <div>
                    <a href="/connexion" style="--i:6;" class="login-btn" >Se connecter</a>
        ...
        <section class="info" id="info">
            ...
            <div class="list-info">
                <div class="box">
                    ...
                    <p>Explorez nos fonctionnalités avancées de gestion des
                        emplois
                ...
                <div class="box">
                    ...
                    <p>Facilitez votre quotidien avec notre interface conviviale
                ...
                <div class="box">
                    ...
                    <p>Optimisez votre expérience de travail en accédant à des
        ...
        <section class="info">
            <div class="list-info">
                <div class="box">
                    ...
                    <p>Chez NannyCare, la sécurité de vos enfants est notre
                ...
                <div class="box">
                    ...
                    <p>Rejoignez dès maintenant la communauté NannyCare en vous
                ...
                <div class="box">
                    ...
                    <p>Découvrez ce que nos utilisateurs disent de Social Home.
