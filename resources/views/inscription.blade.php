            ...
            <div class="login-card">
                ...
                <form class="login-card-form" action="" method="post" id="registration-form">
                    ...
                    <select name="role">
                        ...
                        <option value="admin">Nounou</option>
                    </select>
                    <!-- Champ pour l'email -->
                    ...
                    <button type="submit" class="login-card-form-button login-form-button"><a href="{{ route('showRegistrationForm') }}">Inscription</a></button>
                    <div class="login-or">
                    ...
                    <footer>
                        ...
                        <div class="signup-card-footer">
                            <p>Vous avez déjà un compte ? <a href="/connexion" id="login-link">Connectez-vous</a></p>
                        </div>
